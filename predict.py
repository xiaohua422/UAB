...
if __name__ == "__main__":
    ...
    # -------------------------------------------------------------------------#
    deeplab = DeeplabV3()
    #pspnet = PSPNet(num_classes=13,downsample_factor=8)
    # ----------------------------------------------------------------------------------------------------------#
    #   mode用于指定测试的模式：
    ...
    # ----------------------------------------------------------------------------------------------------------#
    mode = "dir_predict"  # 修改为dir_predict模式
    # -------------------------------------------------------------------------#
    ...
    if mode == "predict":
        ...
        # 设置掩码保存路径
       # 假设你总是在项目根目录下运行脚本（如 D:\unet_test\Deeplabv3+\deeplabv3-plus-pytorch-main-08）
        mask_save_path = os.path.join('phase_mask')
        #mask_save_path = r"D:\unet_test\Deeplabv3+\deeplabv3-plus-pytorch-main-08\pspnet_mask"
        ...
        for img_name in tqdm(img_names):
            if img_name.lower().endswith(
                ...
                # 保存掩码文件
                mask_name = os.path.splitext(img_name)[0] + ".png"  # 统一保存为PNG格式
